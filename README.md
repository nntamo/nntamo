...
-  Aktuell arbeite ich an: Aufbau einer Azure-basierten Plattform zur automatisierten Validierung und Modellierung von Ontologien und Wissensgraphen (Parashift, Databricks, SHACL, RDF)
...
| [Jenkins-Pipeline-CICD](https://github.com/nntamo) | Sichere CI/CD-Pipeline mit Jenkins, automatisierten Build-, Test- und Deployment-Prozessen sowie DevSecOps-Integration (SonarQube, OIDC) | Jenkins, Docker, GitLab, SonarQube, OIDC |
...
<!--
**nntamo/nntamo** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
